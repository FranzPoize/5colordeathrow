...
Crafty.c("ProgressBar", {
	...
	*/
	progressBar : function(maxValue, flipDirection, emptyColor, filledColors) {
		...
		this._pbLowerBlock = Crafty.e("2D, " + renderMethod + ", Color, ProgressBar")
	...
	currentProgress: function () {
		console.log(this._pbFilledFraction)
		console.log(this._pbMaxValue)
		return this._pbFilledFraction * this._pbMaxValue
	},
